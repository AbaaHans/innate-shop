...
<body id="" data-spy="scroll" data-target="#navbar" class="static-layout">
    ...
    <div class="boxed-page">
        ...
        <section id="gtco-menu" class="section-padding">
            ...
            <div class="col-md-6">
                <h3 class="mt-3"><?php echo $data['name'];?>  </h3>
                ...
                <h5 class="mt-4"><?php echo $data['price'];?> <sup>DHS</sup></h5>
             <a href="listepanier.php">   <button class="btn btn-primary mt-4 btn-for_jquery" id="id_<?php echo $data['pid'] ?>" >Acheter</button>  </a>
             <button class="btn btn-outline-success  mt-4 btn-for_jquery" id="id_<?php echo $data['pid'] ?>" >Ajouter au panier</button>
