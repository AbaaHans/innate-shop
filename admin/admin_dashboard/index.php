    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <a class="dropdown-item" href="add_empl.php">Ajouter employé</a>
          <a class="dropdown-item" href="product.php">Ajouter produit</a>
      ...
      <div class="container">
          ...
          <div class="col-xl-4 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"><?php echo $data2['orders']?>  Commandes</div>
              </div>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Graphique en aires Exemple</div>
          <div class="card-body">
